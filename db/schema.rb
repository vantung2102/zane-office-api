...
ActiveRecord::Schema[7.0].define(version: 2023_06_21_165506) do
  ...
  create_table "employees", force: :cascade do |t|
    ...
    t.index ["apple_uid"], name: "index_employees_on_apple_uid"
    t.index ["google_uid"], name: "index_employees_on_google_uid"
  end
